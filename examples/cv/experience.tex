  ...
  \cventry
    ...
    { 
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Development of a pipeline to integrate publicly available and in-house multi-omics data (Chip-seq, SNP, GWAS, conservation, haplotype), to generate reproducible results.}
