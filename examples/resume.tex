...
\name{Romain}{Gallet}
\position{Software Architect{\enskip\cdotp\enskip}Data engineer}
%\address{42-8, Bangbae-ro 15-gil, Seocho-gu, Seoul, 00681, Rep. of KOREA}

\mobile{(+44) 787 243 6423 }
\email{romain.gallet@gmail.com}
\homepage{rentbarometer.com}
\github{grumlimited}
...
Expertise in high availability B2B and B2C solutions architectured around data pipelines and streaming.}

\hypersetup{%
  pdftitle={Romain Gallet~~~·~~~Résumé},
  pdfauthor={Romain Gallet},
  pdfsubject={Romain Gallet~~~·~~~Résumé},
  pdfkeywords={CV, Résumé}
}
