...
A full TeX distribution is assumed.  [Various distributions for different operating systems (Windows, Mac, \*nix) are also available](http://tex.stackexchange.com/q/55437) but TeX Live is recommended.
